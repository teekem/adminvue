              ...
              <div class="app-utilities col-auto">
                  ...
                  >
                    ...
                    <div class="dropdown-menu-content">
                      <div class="item p-3">
                        ...
                        <!--//row-->
                        <router-link class="link-mask"  to="/notifications"></router-link>
                      </div>
                      <!--//item-->
                      <div class="item p-3">
                        <div
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                  <a
                    ...
                    role="button"
                    aria-expanded="false"
                    ><img src="assets/images/user.jpeg" alt="user profile"
                  /></a>
                  <ul
                    class="dropdown-menu"
          ...
          <div class="app-branding">
            <a class="app-logo" href="index.html"
              ><img
                ...
                alt="logo"
              /><span class="logo-text">ADMIN PORTAL</span></a
            >
          </div>
          <!--//app-branding-->
                ...
                >
                  <ul class="submenu-list list-unstyled">
                    <li class="submenu-item">
                      ...
                      <router-link class="submenu-link" to="applicants"
                        >Applicants</router-link
                      >
                    </li>
                    <li class="submenu-item">
                      <router-link   class="submenu-link" to="/account" > Account</router-link>
                    </li>
                    <li class="submenu-item">
                      <router-link   class="submenu-link" to="/settings">Settings</router-link >
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <ul class="app-menu footer-menu list-unstyled">
                ...
                <li class="nav-item">
                  ...
                  >
                    ...
                    <span class="nav-link-text">Download</span> </router-link
                  ><!--//nav-link-->
                </li>
                <!--//nav-item-->
                <li class="nav-item">
                  ...
                  >
                    ...
                    <span class="nav-link-text">License</span> </router-link
                  ><!--//nav-link-->
                </li>
                <!--//nav-item-->
              </ul>
