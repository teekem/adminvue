                    ...
                    <table class="table app-table-hover mb-0 text-left">
                      ...
                      <tbody>
                        <tr v-for="applicant in applicants" :key="applicant.id">
                          <td class="cell">{{applicant.id}}</td>
                          <td class="cell">
                            <span class="truncate">{{applicant.name}}</span>
                          </td>
                          <td class="cell">{{applicant.email}}</td>
                          <td class="cell">
                            <span class="note">{{applicant.created_at}}</span>
                          </td>
                          <td class="cell">
                          ...
                          <td class="cell">
                            <router-link :to="'/applicant/'+applicant.id " class="btn-sm app-btn-secondary" >View </router-link>
                          <!-- { path:'applicants', params: { obj:applicant }} -->
                          </td>
                        </tr>
                    ...
                    <table class="table mb-0 text-left">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="cell">
                            <span class="truncate"
                              >Pellentesque diam imperdiet</span
                            >
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="cell">
                            <span class="truncate"
                              >Vestibulum a accumsan lectus sed mollis
                              ipsum</span
                            >
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="cell">
                            <span class="truncate"
                              >Morbi vulputate lacinia neque et
                              sollicitudin</span
                            >
                          </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="cell">
                            ...
                            ><span class="note">04:23 PM  {{useFind()}}</span>
                          </td>
                          <td class="cell">
...
export default {
 ...
 data(){
    return{
      applicants: this.$store.getters['User/getUsers']
 ...
 methods: {
    useFind(){
     ...
     let ans = this.applicants.find(obj => {return obj.id ===17})
     return ans
    }
 },
 created() {
