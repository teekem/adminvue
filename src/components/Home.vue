        ...
        <div class="container-xl">
              ...
              <div class="app-card-body p-3 p-lg-4">
                ...
                <div class="row gx-5 gy-3">
                  <div class="col-12 col-lg-9">
                    <div>
                      The ultimate goal of a university is the acquisition, conservation, 
                      dissemination and application of knowledge. 
                      What distinguishes a university from another is the way the goal is pursued.
                    </div>
                  </div>
                  <!--//col-->
                  <div class="col-12 col-lg-3">
                    <a
                      ...
                      ><svg
                        ...
                        height="1em"
                        viewBox="0 0 16 16"
                        class="bi bi-file-earmark-arrow-down mr-2"
                        fill="currentColor"
          ...
          <div class="row g-4 mb-4">
            ...
            <div class="col-6 col-lg-3">
              <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                  <h4 class="stats-type mb-1">Admitted</h4>
            ...
            <div class="col-6 col-lg-3">
              <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                  <h4 class="stats-type mb-1">Info</h4>
              ...
              <div class="app-card app-card-chart h-100 shadow-sm">
                ...
                <div class="app-card-body p-3 p-lg-4">
                  <div class="mb-3 d-flex">
                    <select
                      class="form-select form-select-sm ml-auto d-inline-flex w-auto"
                    >
